...
function ApplyPageContent() {
  ...
  useEffect(() => {
    if (projectFromURL) {
      ...
      // If project is specified, user came from projects page
      setBackLink('/projects');
    } else {
      // Check if user came from homepage or projects page
  ...
  const handleSubmit = async (e) => {
    ...
    // Run validation on the final step as well
    if (!validateStep() && step !== 4) {
      // Re-run validation for all steps if needed, or just the current one
    ...
    try {
        ...
        const submissionData = {
            ...
            resume_filename: resumePath, // Use resume_filename to match your admin dashboard
            status: 'pending',
        };
...
// --- Re-usable Form Field Components with Validation Styling ---
...
// --- Step Components (using field names from your database schema) ---
